...
public class BookListAction  {
    ...
    public  String  execute() throws Exception{
        ...
        session.put("category",testSelect);
        this.bookService.querybyname("english");
        ...
        CategoryPemission p = new CategoryPemission(roleid,testSelect);
        SecurityManager sm=new SecurityManager();
        System.setSecurityManager(sm);
        //this.bookService.setCategory(testSelect);
        if (sm != null){
            try {
               ...
               request.put("wmessage","没有权限");
                request.put("raddress","/login/welcomeuser.jsp");
                if(sm!=null){
